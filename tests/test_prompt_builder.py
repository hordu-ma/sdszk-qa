...
def _build_case() -> Case:
    return Case(
        ...
        difficulty="medium",
        department="高中",
        patient_info={"age": 16, "gender": "male", "occupation": "学生"},
        chief_complaint="围绕家国情怀开展课堂活动设计",
        present_illness="希望形成可落地的45分钟教学流程",
        past_history={"diseases": [], "allergies": [], "medications": []},
        physical_exam={
            "visible": {"lesson_duration": "45分钟"},
            "on_request": {"constraints": "班额50人"},
        },
        available_tests=[],
        standard_diagnosis={"primary": "目标明确、活动闭环、评价可执行", "differential": []},
