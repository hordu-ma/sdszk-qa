---
description: "Use when creating or refactoring Codex-facing workflow files such as AGENTS.md, .instructions.md, .agent.md, project skills, or harness documentation."
applyTo: "AGENTS.md, .github/**/*.md, src/docs/codex-*.md, Makefile"
---

# Codex Customization Guidelines
...
- Treat `AGENTS.md`, `src/docs/codex-*.md`, `Makefile`, and `.github/skills/` as the Codex-facing workflow surface.
- Make descriptions explicit about when the instruction, skill, or agent should be invoked so Codex and humans can discover them reliably.
