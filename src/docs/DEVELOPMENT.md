...
- 当前已实现：vLLM 问答主链、教学项目/资料/任务、版本化语义 RAG、八个产品 Skills、显式 Memory、纵向样板、可配置非评分规则、专业输入、WP2.2 结构化生成，以及 WP2.3 的教案结构校正、证据定位、逐条决定、L4 信号和仅采纳项二次修订；WP2.4 第一增量交付了评测回归门禁（发布清单变更检测与内部阈值阻断）。M1-int、WP2.1–WP2.3 已内部工程收口，但模拟资料、分学段正式量规、内部工程评测和内部可用性验证不得写成专家或客户验收，阶段 2/G2 尚未完成。详见 [README](../../README.md)和 [WP2.3 收口记录](2026-stage2-wp23-closure.md)。
