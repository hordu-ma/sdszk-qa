...
- 当前已实现：vLLM 问答主链、教学项目/资料/任务、版本化语义 RAG、七个产品 Skills、显式 Memory、纵向样板、可配置非评分规则、专业输入，以及 WP2.2 的结构化编辑、服务端锁定、局部重生成、来源版本保护、字段差异、历史恢复、五类配套成果和标准 Word 汇总。M1-int、WP2.1 与 WP2.2 已内部工程收口，但模拟资料、客户专属模板、内部工程评测和内部可用性验证不得写成专家或客户验收，阶段 2/G2 尚未完成。详见 [README](../../README.md)、[WP2.1 收口记录](2026-stage2-wp21-closure.md)和 [WP2.2 收口记录](2026-stage2-wp22-closure.md)。
- 产品范围、阶段和验收只看一份文档：[主开发计划](2026-luyun-curriculum-pedagogy-development-plan.md)（v1.0 签字版，当前 v1.2）。目标能力不等于已实现能力，写文档和注释时不要混淆。
- 当前处于自助开发模式（主计划 §0.5，2026-07-17 起）：客户/专家输入冻结为补签清单，开发按内部代理决策、内部金标 v0 和 M0-int/M1-int 内部门推进；内部产物不得表述为客户确认或专家签字。
