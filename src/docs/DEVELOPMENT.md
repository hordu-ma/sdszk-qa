...
- 当前已实现：vLLM 问答主链、教学项目/资料/任务、版本化语义 RAG、八个产品 Skills、显式 Memory、纵向样板、可配置非评分规则、专业输入、WP2.2 结构化生成，以及 WP2.3 的教案结构校正、证据定位、逐条决定、L4 信号和仅采纳项二次修订；WP2.4 交付了评测回归门禁（发布清单变更检测与内部阈值阻断）与抽检队列/L4 信号维度汇总（双评—分歧—第三人仲裁）；WP2.5 第一增量交付了安全测试与输入防护（恶意文件真实内容校验、提示注入数据定界与历史角色白名单、跨用户越权与角色边界回归套件）。M1-int、WP2.1–WP2.4 已内部工程收口，WP2.5 第一增量已交付，但模拟资料、分学段正式量规、内部工程评测和内部可用性验证不得写成专家或客户验收，安全防护为工程缓解措施不代表渗透测试，阶段 2/G2 尚未完成。详见 [README](../../README.md)、[WP2.3 收口记录](2026-stage2-wp23-closure.md)、[WP2.4 收口记录](2026-stage2-wp24-closure.md)和 [WP2.5 收口记录](2026-stage2-wp25-closure.md)。
